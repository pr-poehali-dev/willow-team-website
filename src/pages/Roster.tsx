...
const academy = [
  {
    ...
    nickname: "Phoenix",
    role: "Универсал",
    realName: "Егор Смирнов",
    age: 19,
    country: "🇷🇺 Россия",
    achievements: "Выпускник академии 2025",
    stats: { winrate: "68%", kda: "3.2", games: "89" },
  },
  {
    id: 7,
    nickname: "Shadow",
    role: "Стрелок",
    realName: "Михаил Лебедев",
    age: 20,
    country: "🇷🇺 Россия",
    achievements: "Перспективный игрок",
    stats: { winrate: "65%", kda: "3.0", games: "76" },
  },
  {
    id: 8,
    nickname: "Echo",
    role: "Поддержка",
    realName: "Никита Козлов",
    age: 18,
    country: "🇷🇺 Россия",
    achievements: "Лучший новичок академии",
    stats: { winrate: "62%", kda: "2.7", games: "64" },
  },
  {
    id: 9,
    nickname: "Spark",
    role: "Снайпер",
    realName: "Даниил Морозов",
    age: 19,
    country: "🇷🇺 Россия",
    achievements: "Юниорский чемпион 2025",
    stats: { winrate: "66%", kda: "3.4", games: "71" },
  },
];

const PlayerCard = ({ player }: { player: typeof mainTeam[0] }) => {
  return (
    <Card className="bg-card border-border overflow-hidden hover:border-primary transition-all duration-300 hover:scale-105 group">
